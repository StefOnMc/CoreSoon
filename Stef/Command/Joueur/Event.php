...
class Event extends VanillaCommand
{
	...
	public function execute(CommandSender $sender, string $commandLabel, array $args)
	{
		if($sender instanceof Player){
			...
			$event->getInventory()->setItem(0,VanillaBlocks::STAINED_GLASS()->setColor(DyeColor::LIGHT_BLUE())->asItem());
			$event->getInventory()->setItem(1,VanillaBlocks::STAINED_GLASS()->setColor(DyeColor::LIGHT_BLUE())->asItem());
			$event->getInventory()->setItem(9,VanillaBlocks::STAINED_GLASS()->setColor(DyeColor::LIGHT_BLUE())->asItem());
			$event->getInventory()->setItem(7,VanillaBlocks::STAINED_GLASS()->setColor(DyeColor::LIGHT_BLUE())->asItem());
			$event->getInventory()->setItem(8,VanillaBlocks::STAINED_GLASS()->setColor(DyeColor::LIGHT_BLUE())->asItem());
			$event->getInventory()->setItem(17,VanillaBlocks::STAINED_GLASS()->setColor(DyeColor::LIGHT_BLUE())->asItem());
			$event->getInventory()->setItem(36,VanillaBlocks::STAINED_GLASS()->setColor(DyeColor::LIGHT_BLUE())->asItem());
			$event->getInventory()->setItem(45,VanillaBlocks::STAINED_GLASS()->setColor(DyeColor::LIGHT_BLUE())->asItem());
			$event->getInventory()->setItem(46,VanillaBlocks::STAINED_GLASS()->setColor(DyeColor::LIGHT_BLUE())->asItem());
			$event->getInventory()->setItem(44,VanillaBlocks::STAINED_GLASS()->setColor(DyeColor::LIGHT_BLUE())->asItem());
			$event->getInventory()->setItem(52,VanillaBlocks::STAINED_GLASS()->setColor(DyeColor::LIGHT_BLUE())->asItem());
			$event->getInventory()->setItem(53,VanillaBlocks::STAINED_GLASS()->setColor(DyeColor::LIGHT_BLUE())->asItem());
